            ...
            <div class="d-flex flex-center flex-column flex-column-fluid">
               ...
               <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center mb-10">
                            <!--begin::Title-->
                            <h1 class="text-dark mb-3">تسجيل دخول</h1>
                            <!--end::Title-->
                            <!--begin::Link-->
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <label class="form-label fs-6 fw-bolder text-dark">اسم المستخدم</label>
                                                        ...
                                                        <input id="name" type="text" class="form-control form-control-lg form-control-solid @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus>
                        ...
                        <div class="text-center">
                            ...
                            <button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary w-100 mb-5" >
                                <span class="indicator-label">استمرار</span>
