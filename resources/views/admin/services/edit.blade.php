        ...
        <div class="card-body py-1">
            ...
            <div class="mb-13 mt-5 text-start">
                ...
                <div class="text-gray-400 fw-bold fs-5">
                    <a href="{{route('admin.services.index')}}" class="fw-bolder link-primary">جميع الخدمات</a>.
                </div>
                <!--end::Description-->
            </div>
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('admin.services.update',['service' => $service]),'method'=>'put','redirect'=>route("admin.services.index")])
