        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-table-toolbar="base">
                    ...
                    <a href="{{route('admin.typeService.create')}}" class="btn btn-success "> إضافة نوع خدمة <i class="fa fa-plus"></i></a>
...
@push('js')
    ...
    @include('admin.typeService._datatable')
    @include("parts.sweetDelete", ['route' => route('admin.typeService.destroy', ['typeService' => ':id'])])
@endpush
