...
@section('title','الرسائل والاستشارات')
@section('toolbar.title','الرسائل والاستشارات')
@section('breadcrumb')
    <!--begin::Item-->
            ...
            <!--begin::Table-->
                <table id="table_id"
                    ...
                    <tr class="fw-bolder  bg-secondary text-muted ">
                        ...
                        <th class="w-10  text-center"  style="width:10%">الإسم </th>
                        <th class="w-10  text-center" style="width:15%">العنوان</th>
                        <th class="w-10  text-center" style="width:10%">رقم الهاتف</th>
                        <th class="w-10  text-center" style="width:10%">التاريخ </th>
...
@push('js')
    ...
    @include('admin.contacts._datatable')
    @include("parts.sweetDelete", ['route' => route('admin.contact.destroy', ['contact' => ':id'])])
@endpush
