        ...
        <div class="card-body py-1">
            ...
            <div class="mb-13 mt-5 text-start">
                ...
                <div class="text-gray-400 fw-bold fs-5">
                    <a href="{{route('admin.reviews.index')}}" class="fw-bolder link-primary">جميع المراجعات</a>.
                </div>
                <!--end::Description-->
            </div>
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('admin.reviews.update',['id' => $review->id]),'method'=>'put','redirect'=>route("admin.reviews.index")])
