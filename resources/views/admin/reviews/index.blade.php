        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-table-toolbar="base">
                    ...
                    <a href="{{route('admin.reviews.create')}}" class="btn btn-success "> إضافة مراجعة <i class="fa fa-plus"></i></a>
            ...
            <!--begin::Table-->
                <table id="table_id"
                    ...
                    <tr class="fw-bolder  bg-secondary text-muted ">
                        ...
                        <th class="w-10  text-center"  style="width:10%">العنوان الفرعي/المهنة</th>
...
@push('js')
    ...
    @include('admin.reviews._datatable')
    @include("parts.sweetDelete", ['route' => route('admin.reviews.destroy', ['id' => ':id'])])
@endpush
