...
@section('title','إظهار الخبراء ')
@section('toolbar.title','الخبراء')
@section('breadcrumb')
    <!--begin::Item-->
    ...
    <li class="breadcrumb-item text-muted">الخبراء</li>
@endsection
@push('css')
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-table-toolbar="base">
                    ...
                    <a href="{{route('admin.experts.create')}}" class="btn btn-success "> إضافة خبير <i class="fa fa-plus"></i></a>
            ...
            <!--begin::Table-->
                <table id="table_id"
                    ...
                    <tr class="fw-bolder  bg-secondary text-muted ">
                        ...
                        <th class="w-10  text-center"  style="width:10%">اسم الخبير</th>
                        <th class="w-10  text-center"  style="width:10%">المهنة</th>
...
@push('js')
    ...
    @include('admin.experts._datatable')
    @include("parts.sweetDelete", ['route' => route('admin.experts.destroy', ['expert' => ':id'])])
@endpush
