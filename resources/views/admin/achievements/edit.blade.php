        ...
        <div class="card-body py-1">
            ...
            <div class="mb-13 mt-5 text-start">
                ...
                <div class="text-gray-400 fw-bold fs-5">
                    <a href="{{route('admin.achievements.index')}}" class="fw-bolder link-primary">جميع الانجازات</a>.
                </div>
                <!--end::Description-->
            </div>
            ...
            <!--begin::Input group-->
                ...
                @include('admin.achievements._fields')
...
@endsection
@push('js')
    @include("parts.sweetCreate", ['route' => route('admin.achievements.update',['achievement' => $achievement]),'method'=>'put','redirect'=>route("admin.services.index")])
