        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-table-toolbar="base">
                    ...
                    <a href="{{route('admin.achievements.create')}}" class="btn btn-success "> إضافة انجاز <i class="fa fa-plus"></i></a>
            ...
            <!--begin::Table-->
                <table id="table_id"
                    ...
                    <tr class="fw-bolder  bg-secondary text-muted ">
                        ...
                        <th class="w-10  text-center" style="width:15%">تاريخ الانجاز</th>
...
@push('js')
    ...
    @include('admin.achievements._datatable')
    @include("parts.sweetDelete", ['route' => route('admin.achievements.destroy', ['achievement' => ':id'])])
@endpush
