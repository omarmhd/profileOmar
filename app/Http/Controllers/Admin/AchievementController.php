        ...
        if ($request->ajax()) {
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($data) {
                    $actionBtn = '<a href="' . route('admin.achievements.edit', [$data]) . '" class="edit btn btn-primary btn-sm">تعديل</a> <a href="javascript:void(0)" data-id="' . $data->id . '"   class="delete btn btn-sm btn-danger">حذف</a>';
                    return $actionBtn;
